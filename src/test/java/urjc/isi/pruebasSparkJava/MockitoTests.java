...
public class MockitoTests {
	...
	public void MockListSize() {
		List list = mock(List.class);//cambio list
		when(list.size()).thenReturn(10);//defino el comportamiento del cambiazo que he hecho
	...
	public void MockListSizeWithMultipleReturnValues() {
		...
		when(list.size()).thenReturn(10).thenReturn(20);//devuelve un 10 y si me vuelven a llamar un 20 y las siguientes lo ultimo que le digo
		...
		verify(list, times(3)).size();//comprueba que a list se le ha llamadi 3 veces a su metodo size
	}
